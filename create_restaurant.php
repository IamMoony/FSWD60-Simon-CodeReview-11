...
<body>
  <div class="col-lg-3">
    <h2>Add Item Here</h2>
    <form class="form-horizontal" action="actions/a_create_restaurant.php" method="POST">
      ...
      <div class="form-group">
        <label class="control-label col-sm-2">Item Tel</label>
        <div class="col-sm-10">          
          <input type="text" class="form-control" name="itemtel">
        </div>
      </div>
      <div class="form-group">
